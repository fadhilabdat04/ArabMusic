...
def get_user_list(config, key):
    with open("{}/HentaiRobot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "ygmuteebabi"
    BOT_USERNAME = "HentaiRobot"
    SUPPORT_CHAT = "ygmuteebabi"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001748076180
