...
def get_user_list(__init__, key):
    with open("{}/HentaiRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[HentaiRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[HentaiRobot]')
LOGGER.info("Hentai is starting. | An Alex Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/alexgansg (t.me/ygmuteebabi)")
...
from HentaiRobot.modules.sql import SESSION
...
from HentaiRobot.modules.helper_funcs.handlers import (
